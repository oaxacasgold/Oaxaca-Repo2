...
export class PromptDjMidi extends LitElement {
  ...
  // Fix: Remove arguments from constructor
  constructor() {
    super();
    this.midiDispatcher = new MidiDispatcher();
  }

  // Fix: Add method to set prompts
  ...
  private handlePromptChanged(e: CustomEvent<Prompt>) {
    ...
    // Fix: Cast this to any to access requestUpdate
    (this as any).requestUpdate();

    // Fix: Cast this to any to access dispatchEvent
